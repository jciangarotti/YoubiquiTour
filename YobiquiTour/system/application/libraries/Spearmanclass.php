...
class Spearmanclass {
    ...
    */
    function setSpearman($array, $boolean){
      $distancia = 0;
      $distanciaCuadrado = 0;
      ...
      $this-> printVerbose("<br>", $boolean);
      $this-> printVerbose("Para un total de n =  $n evaluaciones <br/><br/>", $boolean);
      //Calculamos Spearman
      $spearman = 1-((6*$distancia)/($n*((pow($n,2)-1))));
      $this->printVerbose("Spearman = 1-((6*$distancia)/($n*((pow($n,2)-1)))) = $spearman<br/>", $boolean); //verbose
